...
const plans = [
  { name: "Web Essential", price: "$999 / yr", gradient: "from-[#01686d] to-[#00444b]" },
  { name: "Web Advanced", price: "$1999 / yr", gradient: "from-[#f27b22] to-[#c85f12]", badge: "Best Seller" },
  { name: "Web Professional", price: "$2999 / yr", gradient: "from-[#01686d] to-[#00444b]" },
  { name: "Web Enterprise", price: "$3999 / yr", gradient: "from-[#f27b22] to-[#c85f12]" },
];
              ...
              <div className="relative bg-white rounded-3xl p-8 h-full backdrop-blur-xl">
                {plan.badge && (
                  <span className="absolute -top-4 left-1/2 -translate-x-1/2
                                   bg-[#f27b22] text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg">
                    {plan.badge}
                  </span>
                )}
