...
function ECommerceDevelopment() {
  ...
  const technologies = [
    ...
    { name: "Stripe", icon: <SiStripe className="text-5xl" /> },
    { name: "Shopify", icon: <SiShopify className="text-5xl" /> },
  ];
  ...
  return (
    <div className="w-full font-['Inter']">
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-bold mb-2">E-Commerce Development</h1>
        <p className="text-sm sm:text-base max-w-lg mx-auto opacity-90">
          Build fast, secure & scalable e-commerce websites to grow your online business.
        </p>
      </motion.div>
      ...
      >
        <div className="max-w-5xl mx-auto text-center mb-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug mx-auto">
            WE BUILD SECURE & MODERN E-COMMERCE PLATFORMS
          </h2>
          <p className="text-[#00444b] text-sm sm:text-base max-w-2xl mx-auto mt-3">
            High-performance online stores and web apps that help businesses sell efficiently online.
          </p>
        </div>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="mt-3 text-sm sm:text-base text-[#00444b]/70 max-w-2xl mx-auto">
            Modern tech stack to build seamless, scalable, and secure e-commerce solutions.
          </p>
      ...
      >
        <div className="max-w-6xl mx-auto text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-extrabold">
            Why Choose <span className="text-[#f27b22]">Our E-Commerce Development?</span>
          </h2>
          <p className="mt-3 max-w-2xl mx-auto text-sm sm:text-base text-[#00444b]/80">
            We create secure, scalable, and conversion-focused e-commerce platforms using modern technology stack.
          </p>
        </div>
