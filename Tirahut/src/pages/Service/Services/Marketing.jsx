...
function Marketing() {
  ...
  const technologies = [
    { name: "Google Ads", icon: <FaGoogle className="text-5xl" /> },
    { name: "Facebook Ads", icon: <FaFacebookF className="text-5xl" /> },
    { name: "Instagram", icon: <FaInstagram className="text-5xl" /> },
    { name: "Twitter Ads", icon: <FaTwitter className="text-5xl" /> },
    { name: "LinkedIn Ads", icon: <FaLinkedinIn className="text-5xl" /> },
    { name: "Mailchimp", icon: <SiMailchimp className="text-5xl" /> },
    { name: "YouTube Ads", icon: <SiYoutube className="text-5xl" /> },
  ];
  ...
  return (
    <div className="w-full font-['Inter']">
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-bold mb-2">Digital Marketing</h1>
        <p className="text-sm sm:text-base max-w-lg mx-auto opacity-90">
          Grow your business online with targeted campaigns and result-driven strategies.
        </p>
      </motion.div>
      ...
      >
        <div className="max-w-5xl mx-auto text-center mb-6">
          ...
          <p className="text-[#00444b] text-sm sm:text-base max-w-2xl mx-auto mt-3">
            We create marketing strategies that deliver measurable results and boost online growth.
          </p>
        </div>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#00444b]">TOOLS & PLATFORMS WE USE</h2>
          <p className="mt-3 text-sm sm:text-base text-[#00444b]/70 max-w-2xl mx-auto">
            We leverage modern marketing platforms to maximize your digital reach.
          </p>
      ...
      >
        <div className="max-w-6xl mx-auto text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-extrabold">
            Why Choose <span className="text-[#f27b22]">Our Marketing Services?</span>
          </h2>
          <p className="mt-3 max-w-2xl mx-auto text-sm sm:text-base text-[#00444b]/80">
            We deliver measurable growth using proven strategies, modern tools, and creative campaigns.
          </p>
        </div>
